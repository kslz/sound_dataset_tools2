...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QRect(10, 10, 1141, 476))
        self.tableWidget.verticalHeader().setVisible(False)
        self.comboBox = QComboBox(self.widget_2)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(10, 490, 201, 31))
        font = QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\u6807\u6ce8\u6587\u672c", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"\u53d1\u97f3\u4eba", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"\u72ec\u7acb\u6587\u4ef6", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"\u6807\u7b7e", None));
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"\u6570\u636e\u96c6\u6982\u89c8", None))
