...
class Ui_OutPutSpeakerDialog(object):
    def setupUi(self, OutPutSpeakerDialog):
        ...
        OutPutSpeakerDialog.resize(540, 563)
        font = QFont()
        ...
        self.pushButton_next.setGeometry(QRect(430, 520, 75, 24))
        self.pushButton_back = QPushButton(OutPutSpeakerDialog)
        self.pushButton_back.setObjectName(u"pushButton_back")
        self.pushButton_back.setGeometry(QRect(320, 520, 75, 24))
        ...
        self.groupBox_3.setGeometry(QRect(30, 390, 491, 111))
        self.comboBox = QComboBox(self.groupBox_3)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(10, 30, 211, 22))
        self.label_score1 = QLabel(self.groupBox_3)
        self.label_score1.setObjectName(u"label_score1")
        self.label_score1.setGeometry(QRect(240, 20, 71, 16))
        self.label_score2 = QLabel(self.groupBox_3)
        self.label_score2.setObjectName(u"label_score2")
        self.label_score2.setGeometry(QRect(240, 40, 71, 16))
        self.label_score3 = QLabel(self.groupBox_3)
        self.label_score3.setObjectName(u"label_score3")
        self.label_score3.setGeometry(QRect(240, 60, 71, 16))
        self.label_score5 = QLabel(self.groupBox_3)
        self.label_score5.setObjectName(u"label_score5")
        self.label_score5.setGeometry(QRect(370, 20, 61, 16))
        self.spinBox_score1 = QSpinBox(self.groupBox_3)
        self.spinBox_score1.setObjectName(u"spinBox_score1")
        self.spinBox_score1.setGeometry(QRect(320, 20, 42, 20))
        self.spinBox_score1.setMaximum(100)
        self.spinBox_score1.setValue(60)
        self.spinBox_score2 = QSpinBox(self.groupBox_3)
        self.spinBox_score2.setObjectName(u"spinBox_score2")
        self.spinBox_score2.setGeometry(QRect(320, 40, 42, 20))
        self.spinBox_score2.setMaximum(100)
        self.spinBox_score2.setValue(60)
        self.spinBox_score3 = QSpinBox(self.groupBox_3)
        self.spinBox_score3.setObjectName(u"spinBox_score3")
        self.spinBox_score3.setGeometry(QRect(320, 60, 42, 20))
        self.spinBox_score3.setMaximum(100)
        self.spinBox_score3.setValue(60)
        self.spinBox_score5 = QSpinBox(self.groupBox_3)
        self.spinBox_score5.setObjectName(u"spinBox_score5")
        self.spinBox_score5.setGeometry(QRect(440, 20, 42, 20))
        self.spinBox_score5.setMaximum(100)
        self.spinBox_score5.setValue(80)
        self.label_score4 = QLabel(self.groupBox_3)
        self.label_score4.setObjectName(u"label_score4")
        self.label_score4.setGeometry(QRect(240, 80, 71, 16))
        self.spinBox_score4 = QSpinBox(self.groupBox_3)
        self.spinBox_score4.setObjectName(u"spinBox_score4")
        self.spinBox_score4.setGeometry(QRect(320, 80, 42, 20))
        self.spinBox_score4.setMaximum(100)
        self.spinBox_score4.setValue(60)
...
"......", None))
        ...
        self.label_score1.setText(QCoreApplication.translate("OutPutSpeakerDialog", u"\u51c6\u786e\u5ea6\uff1a", None))
        self.label_score2.setText(QCoreApplication.translate("OutPutSpeakerDialog", u"\u6d41\u5229\u5ea6\uff1a", None))
        self.label_score3.setText(QCoreApplication.translate("OutPutSpeakerDialog", u"\u5b8c\u6574\u5ea6\uff1a", None))
        self.label_score5.setText(QCoreApplication.translate("OutPutSpeakerDialog", u"\u603b\u5206\uff1a", None))
        self.label_score4.setText(QCoreApplication.translate("OutPutSpeakerDialog", u"\u5b8c\u6574\u5ea6\uff1a", None))
    # retranslateUi
