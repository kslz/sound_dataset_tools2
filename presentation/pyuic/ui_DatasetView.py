...
class Ui_DatasetViewMainWindow(object):
    def setupUi(self, DatasetViewMainWindow):
        ...
        DatasetViewMainWindow.setMinimumSize(QSize(1200, 800))
        DatasetViewMainWindow.setMaximumSize(QSize(1200, 800))
    ...
    def retranslateUi(self, DatasetViewMainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("DatasetViewMainWindow", u"\u6570\u636e\u96c6\u6982\u89c8", None))
        self.pushButton_biaobei_pingce.setText(QCoreApplication.translate("DatasetViewMainWindow", u"\u6807\u8d1d\u8bed\u97f3\u8bc4\u6d4b", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("DatasetViewMainWindow", u"\u6570\u636e\u5904\u7406", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QCoreApplication.translate("DatasetViewMainWindow", u"\u8f6f\u4ef6\u8bbe\u7f6e", None))
    # retranslateUi
